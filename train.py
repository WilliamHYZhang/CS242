...
if __name__ == "__main__":
	...
	if args.ta:
		...
		if args.ta_checkpoint:
			...
			ta_trainer = TrainManager(teacher_model, teacher=None, train_loader=train_loader, test_loader=test_loader, train_config=teacher_train_config)
			ta_trainer.train()
	...
	student_trainer = TrainManager(student_model, teacher=teacher_model, ta=ta_model, train_loader=train_loader, test_loader=test_loader, train_config=student_train_config)
